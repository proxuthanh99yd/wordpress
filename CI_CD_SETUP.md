...
4. **Chạy Certbot để cài SSL:**
    ...
    sudo certbot --nginx -d 360home.vn -d www.your-domain.com
...
root@360Home:/var/www/cms.360lumihanoi# cat .env
MYSQL*ROOT_PASSWORD=cmslumihanoiroot
MYSQL_DATABASE=cmslumihanoi
MYSQL_USER=cmslumihanoiuser
MYSQL_PASSWORD=cmslumihanoipw
WP_TABLE_PREFIX=wp*
WORDPRESS_URL=https://cms.360lumihanoi.vn

# Redis configuration

REDIS_HOST=redis
REDIS_PORT=6379
REDIS_PASSWORD=redis_secret_pw

NEXT_PUBLIC_CMS=https://cms.360home.okhub-tech.com
NEXT_PUBLIC_API=/wp-json/
GOOGLE_CLIENT_ID=your_google_client_id_here
GOOGLE_CLIENT_SECRET=your_google_client_secret_here
AUTH_SECRET=AVA_SECRET
NEXT_PUBLIC_API_CF7=https://cms.360home.okhub-tech.com/wp-json/contact-form-7/v1/contact-forms
NEXT_PUBLIC_DOMAIN=https://360home.vn
AUTH_TRUST_HOST=true
AUTH_URL=https://360lumihanoi.vn
AUTH_REDIRECT_PROXY_URL=https://360lumihanoi.vn/api/auth
ALLOW_SEARCH_ENGINE_INDEX=true
HOSTNAME_DEFAULT=360home.vn
HOSTNAME_LUMIHANOI=360lumihanoi.vn
~
